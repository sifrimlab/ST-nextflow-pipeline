...
def orb_sim(img1, img2):
  # SIFT is no longer available in cv2.cv2 so using ORB
...
img00 = cv2.cv2.imread('images/monkey_distorted.jpg', 0)
img01 = cv2.cv2.imread('images/monkey_rotated.jpg', 0)

img1 = cv2.cv2.imread('images/BSE.jpg', 0)  # 714 x 901 pixels
img2 = cv2.cv2.imread('images/BSE_noisy.jpg', 0)  # 714 x 901 pixels
img3 = cv2.cv2.imread('images/BSE_smoothed.jpg', 0)  # 203 x 256 pixels
img4 = cv2.cv2.imread('images/different_img.jpg', 0)  # 203 x 256 pixels
