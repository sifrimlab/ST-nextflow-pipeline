...
round_csv_list = [sys.argv[i] for i in range(4, len(sys.argv))]
...
try:
    closest_ref_point_dict, attribute_dict = checkSpotsInRoundPrecision(ref_spots_csv, round_csv_list, round_nr, pixel_distance=pixel_distance, x_column_name="Original_X", y_column_name="Original_Y")
except TypeError:
