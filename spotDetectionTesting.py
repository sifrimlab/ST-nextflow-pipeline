...
img_path = "/media/david/Puzzles/starfish_test_data/ExampleInSituSequencing/DO/REF.TIF"
...
# sigmas = raw_blobs[:,2]
blobs = detectSpots(filtered_image, 1,10)
sigmas = blobs[:,2]
